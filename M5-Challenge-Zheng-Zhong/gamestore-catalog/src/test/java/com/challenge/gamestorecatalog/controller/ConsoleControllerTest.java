package com.challenge.gamestorecatalog.controller;

import com.challenge.gamestorecatalog.service.GameStoreCatalogServiceLayer;
...
//        when(storeServiceLayer.getConsoleById(16)).thenReturn(null);
        doReturn(null).when(storeServiceLayer).getConsoleById(16);
