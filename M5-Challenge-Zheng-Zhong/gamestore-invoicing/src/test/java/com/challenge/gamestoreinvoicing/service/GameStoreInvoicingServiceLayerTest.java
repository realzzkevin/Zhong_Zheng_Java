...
public class GameStoreInvoicingServiceLayerTest {
    ...
    public void setUp() throws Exception {
        ...
        setUpCatalogFeighMock();

        service = new GameStoreInvoicingServiceLayer( catalog, invoiceRepository, taxRepository, processingFeeRepository);
    }
    ...
    public void shouldFailWhenCreateInvoiceInvalidItem() {
        ...
        service.createInvoice(invoiceViewModel);
    }
